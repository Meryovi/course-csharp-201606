...
namespace ProyectoCSharp.Libreria.Repositorios
{
    ...
    /// </summary>
    public class RepositorioPersonasEF : IRepositorioPersonas, IDisposable
    {
        ...
        private readonly PersonasDbContext dbContext;

        /// <summary>
        /// Inicializa una nueva instancia de la clase.
        /// </summary>
        public RepositorioPersonasEF()
        {
            dbContext = new PersonasDbContext();
        }
        ...
        {
            // El método FirstOrDefault de LINQ permite obtener
